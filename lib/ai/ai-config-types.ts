...
export type TextGenerationModel = GoogleTextModel | OpenAITextModel | AnthropicTextModel;
...
export function getModelsForProvider(providerName: AIProviderName): readonly string[] {
    switch (providerName) {
        case 'Google':
...
export function getDefaultModelForProvider(providerName: AIProviderName): TextGenerationModel {
    switch (providerName) {
        case 'Google':
